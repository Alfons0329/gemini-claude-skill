...
- **Reference:** Use web fetching tools (`web_fetch`, `read_url_content`, or `WebFetch`) to retrieve problem descriptions and constraints from the provided URL to ensure accuracy.
