...
- **Page ID Extraction:** Parse the Notion URL (e.g., `https://www.notion.so/Your-Page-Title-1234abcd5678ef901234abcd5678ef90`) to extract the 32-character hexadecimal UUID at the end of the URL path (e.g., `1234abcd5678ef901234abcd5678ef90` -> `1234abcd-5678-ef90-1234-abcd5678ef90`).
- **Traversal Flow:**
...
1. Navigate to the helper script directory [shared/scripts](shared/scripts).
